...
const DashboardCampaignOverview = ( {
                                        campaigns, isLoading, error, refetch
                                    }: DashboardCampaignOverviewProps ) => {
                                ...
                                <div className="flex items-start justify-between">
                                    <div className="space-y-2 flex-1">
                                        ...
                                        <div className="flex items-center space-x-4 text-xs text-gray-500">
                                            ...
                                            <span>•</span>
                                            <span
                                                className="capitalize">{campaign.postType.replace( '_', ' ' )} posts</span>
                                            {campaign.cadence.daysOfWeek.length === 7 ? (
                                                <>
                                                    <span>•</span>
                                                ...
                                                <>
                                                    <span>•</span>
                                                    <span>{campaign.cadence.daysOfWeek.length}x per week</span>
                                                </>
                                            )}
                                        </div>
                                    </div>
