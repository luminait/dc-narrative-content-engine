...
export async function updateMergeFieldAction(
    ...
    try {
        ...
        // 4. Update merge field (excluding 'length' as it's computed)
        ...
        // 6. Serialize Decimals before returning to client
...
export async function duplicateMergeFieldAction(
    ...
    try {
        ...
        // 4. Create duplicate (excluding 'length' as it's computed)
